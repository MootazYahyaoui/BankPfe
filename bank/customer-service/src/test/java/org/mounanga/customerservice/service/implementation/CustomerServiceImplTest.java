...
class CustomerServiceImplTest {
    ...
    void testSearchCustomers(){
        ...
        assertTrue(result.getCustomers().get(0).getFirstname().contains(keyword) || result.getCustomers().get(0).getLastname().contains(keyword));
        int lastIndex = result.getCustomers().size() - 1;
        assertTrue(result.getCustomers().get(lastIndex).getFirstname().contains(keyword) || result.getCustomers().get(lastIndex).getLastname().contains(keyword));
